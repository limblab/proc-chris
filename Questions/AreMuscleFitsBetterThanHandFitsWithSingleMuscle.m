...
clear neurons1
if ~exist('neurons1')
    neurons1 = doOpensimSingleMuscleEncoding(td);
end
neurons1 = getBestMuscle(td, neurons1);
...
%%
musMinHand = neuronsFilt.bestMuscle - neuronsFilt.hand;
musMinJoint = neuronsFilt.bestMuscle -neuronsFilt.joint;
