...
data = [fullPR21, jointPR21, musclePR21, spindlePR21];
figure
bar(data)
%%

tablePR2 = table(td(1).cuneate_unit_guide, fullPR2', jointPR2', musclePR2', 'VariableNames', {'UnitGuide', 'Endpoint', 'Joint', 'Muscle'});
