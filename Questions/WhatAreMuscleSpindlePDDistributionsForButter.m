...
mappedButter = [2,5,3,4,2,10,10,17,17,12,4,4,16,18,17];
mappedCrackle = [12,10,12,16,17,18];
mappedSnap =  [4, 2, 6, 13, 17, 4, 4, 4, 17];

mapped1 = [mappedSnap, mappedCrackle, mappedButter];
% 
...
tmp = [pd{:}];
figure
polarhistogram(tmp, 18, 'FaceColor', 'b', 'FaceAlpha', 1)
