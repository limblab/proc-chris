...
title('R2 of Move Velocity when dropping single unit')
xlabel('R2 of Decoding X velocity')
ylabel('R2 of Decoding Y velocity')
axis square
set(gca,'TickDir','out', 'box', 'off')
