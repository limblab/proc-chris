###########################################################################
## Makefile generated for Simulink model 'MuscleSpindle'. 
## 
## Makefile     : MuscleSpindle.mk
## Generated on : Wed Apr 29 11:34:33 2020
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: .\MuscleSpindle_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = MuscleSpindle_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = MuscleSpindle_ref.rsp
...
MODELLIB                  = MuscleSpindle_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = ContinuousDetectIncrease_rtwlib.lib 
...
PRODUCT = .\MuscleSpindle_rtwlib.lib
...
INCLUDES_BUILDINFO = .\referenced_model_includes;$(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\slprj\grt\MuscleSpindle;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(START_DIR)\slprj\grt\_sharedutils
...
DEFINES_STANDARD = -DMODEL=MuscleSpindle -DNUMST=2 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\slprj\grt\MuscleSpindle\MuscleSpindle.c $(START_DIR)\slprj\grt\MuscleSpindle\MuscleSpindle_data.c
...
OBJS = MuscleSpindle.obj MuscleSpindle_data.obj
...
{$(START_DIR)\slprj\grt\MuscleSpindle}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\grt\MuscleSpindle}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
